package com.chen.baseapplication.tagview.view;
...
//        int widthSpecMode = MeasureSpec.getMode(widthMeasureSpec);
        ...
        Log.e("-------viewGroup------>",widthSpecSize+"  onMeasure------------------"+((mVerticalInterval + mChildHeight) * lines
                - mVerticalInterval + getPaddingTop() + getPaddingBottom()));
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.i("-------viewGroup------>","onSizeChange ----------宽="+w+"高"+h+"  宽oldw="+oldw + "   高oldh="+oldh);
        mRectF.set(0, 0, w, h);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < mViewPos.length / 2; i++) {
            ...
            Log.d("-------viewGroup------>",mViewPos[i * 2]+"  onLayout------------------"+ mViewPos[i * 2 + 1]);
        }
        Log.d("-------viewGroup------>","      结束    onLayout------------------");
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.e("viewgroup","-----------------ondraw____________________");
    }
