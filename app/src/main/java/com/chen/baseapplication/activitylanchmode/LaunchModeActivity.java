...
public class LaunchModeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button2).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(LaunchModeActivity.this,LaunchMode2Activity.class));
            }
        });
    }
    ...
    protected void onNewIntent(Intent intent){
        ...
        Log.e(this.getLocalClassName(),"onNewIntent(Intent intent)1");
        Toast.makeText(this,"onNewIntent1",Toast.LENGTH_LONG).show();
    }
